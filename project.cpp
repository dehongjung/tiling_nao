/* 
  ...
  Author: De Hong Jung
  Email: eu.dehong@gmail.com

  Implementation of a code that allows the humanoid robot NAO to recognize 
  colorful tiles, walk into it, grab them, and put it in another predetermined place.
*/
...
int main(int argc, char* argv[]) {
  ...
  while ((char) cv::waitKey(30) != 27) {
    ...
    inRange(ORANGETrackingFrames, Scalar(28,86,156), Scalar(78, 119, 204),ORANGETrackingFrames); //ORANGE
